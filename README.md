...
## This project is about creating a chatbot using rasa that can answer the FAQ's related to stock market, check the current price of any stock, analyze the sentiments of tweets related to any company, provides latest news and weather updates, tracks the coronavirus cases in any state and check the covid-19 vaccine slot availability in any city within India.
